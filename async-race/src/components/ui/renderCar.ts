  ...
  <div class="road">
    <div class="launch-pad">
      <div class="control-panel">
        <button class="icon start-engine-btn" id="start-engine-car-${id}" ${isEngineStarted ? 'disabled' : ''}>A</button>
        <button class="icon stop-engine-btn" id="stop-engine-car-${id}" ${isEngineStarted ? 'disabled' : ''}>B</button>
      </div>
